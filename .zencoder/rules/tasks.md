...
- [x] 1.1 Create User entity with UserRole enum and BCrypt password encoding
...
- [x] 1.2 Create Department entity and establish User-Department relationship
...
- [x] 1.3 Create Case entity with status enum and user relationships
...
- [x] 1.4 Create Document entity with approval workflow fields
...
- [x] 1.5 Create Communication entity with encryption support
...
- [x] 1.6 Create AuditLog and OtpToken entities
...
- [x] 1.7 Create Spring Data JPA repositories for all entities
...
- [x] 1.8 Configure database connection and apply indexes
...
- [x] 2. Implement authentication and security infrastructure
- [x] 2.1 Create JWT utility class for token generation and validation
...
- [x] 2.2 Implement OTP generation and email service
...
- [x] 2.3 Create JWT authentication filter
...
- [x] 2.4 Configure Spring Security with role-based authorization
...
- [x] 2.5 Implement AuthService with login and 2FA logic
...
- [x] 2.6 Create AuthController with authentication endpoints
...
- [x] 3. Implement user and department management
- [x] 3.1 Create UserService with CRUD operations
...
- [x] 3.2 Create DepartmentService with management operations
...
- [x] 3.3 Create UserController with REST endpoints
...
- [x] 3.4 Create DepartmentController with REST endpoints
...
- [x] 4. Implement document management with file handling
- [x] 4.1 Create file storage service with validation
...
- [x] 4.2 Create DocumentService with approval workflow
...
- [x] 4.3 Implement receipt generation service
...
- [x] 4.4 Create DocumentController with file upload endpoints
...
- [x] 5. Implement case management
- [x] 5.1 Create CaseService with business logic
...
- [x] 6. Implement secure communication system
- [x] 6.1 Create encryption service for message content
...
- [x] 6.2 Create CommunicationService with role-based restrictions
...
- [x] 6.3 Create CommunicationController with messaging endpoints
...
- [x] 7. Implement audit logging and compliance
- [x] 7.1 Create AuditService with automatic logging
...
- [x] 7.2 Create AuditController for auditor access
...
- [x] 8. Implement dashboard and notification features
- [x] 8.1 Create DashboardService to aggregate user-specific data
...
- [x] 8.2 Create DashboardController with aggregated endpoints
...
- [x] 9.1 Create ExportService with CSV and PDF generation
...
- [x] 9.2 Create ExportController with export endpoints
...
- [x] 10. Implement global exception handling and validation
...
- [x] 10.2 Add validation annotations to DTOs
...
- [x] 11. Configure application properties and profiles
- [x] 11.1 Set up application.properties for development
...
- [x] 12. Set up React project structure and core dependencies
- [x] 12.1 Initialize project configuration and install dependencies
...
- [x] 12.2 Create project folder structure
...
- [x] 12.3 Set up shadcn/ui components
...
- [x] 13. Implement authentication and routing
- [x] 13.1 Create TypeScript types and interfaces
...
- [x] 13.2 Create API client service with Axios
...
- [x] 13.3 Create authentication service
...
- [x] 13.4 Create auth store with Zustand
...
- [x] 13.5 Create LoginForm component
...
- [x] 13.6 Create TwoFactorAuth component
...
- [x] 13.7 Create LoginPage and set up routing
...
|- [x] 14. Implement dashboard and layout
|- [x] 14.1 Create layout components
...
|- [x] 14.2 Create dashboard service and hooks
...
|- [x] 14.3 Create dashboard widgets
...
|- [x] 15. Implement document management UI
|- [x] 15.1 Create document service and hooks
...
|- [x] 15.2 Create DocumentUploadForm component
...
|- [x] 15.3 Create DocumentList component
...
|- [x] 15.4 Create DocumentViewer component
...
|- [x] 16. Implement case management UI
|- [x] 16.1 Create case service and hooks
...
|- [x] 16.2 Create CaseForm component
...
|- [x] 16.3 Create CaseList component
...
|- [x] 16.4 Create CaseDetails component
...
|- [x] 17. Implement communication UI
|- [x] 17.1 Create communication service and hooks
...
|- [x] 17.2 Create MessageComposer component
...
|- [x] 17.3 Create MessageThread component
...
|- [x] 17.4 Create CommunicationsPage
...
|- [x] 18. Implement user and department management UI (Admin)
|- [x] 18.1 Create user service and hooks

  - Create services/userService.ts with CRUD methods
  - Create hooks/useUsers.ts using React Query
  - _Requirements: 3.1, 3.2, 3.3, 3.4, 3.5_

|- [x] 18.2 Create UserForm component
...
|- [x] 18.3 Create UserList component
...
|- [x] 20. Implement error handling and notifications
...
|- [x] 20.2 Set up toast notifications

  - Configure shadcn/ui toast component(use sonner)
